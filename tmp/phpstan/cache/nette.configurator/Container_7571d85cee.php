...
class Container_7571d85cee extends _PHPStan_2d0955352\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_7571d85cee $container)
			{
	...
	public function createServiceContainer(): Container_7571d85cee
	{
		return $this;
	}
