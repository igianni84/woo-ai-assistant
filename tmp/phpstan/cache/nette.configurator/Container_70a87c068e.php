...
// source: phar:///Applications/MAMP/htdocs/wp/wp-content/plugins/woo-ai-assistant/vendor/phpstan/phpstan/phpstan.phar/conf/config.level0.neon
...
class Container_70a87c068e extends _PHPStan_2d0955352\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_70a87c068e $container)
			{
	...
	{
		return new PHPStan\Rules\IssetCheck($this->getService('0166'), $this->getService('0167'), false, true, false);
	}
	...
	public function createServiceContainer(): Container_70a87c068e
	{
		return $this;
	}
